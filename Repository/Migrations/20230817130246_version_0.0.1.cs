        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Envios_Clientes_IdCliente",
                        column: x => x.IdCliente,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Envios_Productos_IdProducto",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroFlota = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EnviosMaritimos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EnviosMaritimos_Envios_IdEnvio",
                        column: x => x.IdEnvio,
                        principalTable: "Envios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EnviosMaritimos_Puertos_IdPuerto",
                        column: x => x.IdPuerto,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EnviosTerrestres_Bodegas_IdBodega",
                        column: x => x.IdBodega,
                        principalTable: "Bodegas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EnviosTerrestres_Envios_IdEnvio",
                        column: x => x.IdEnvio,
                        principalTable: "Envios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Envios_IdProducto",
                table: "Envios",
                column: "IdProducto");

            migrationBuilder.CreateIndex(
                name: "IX_EnviosMaritimos_IdEnvio",
                table: "EnviosMaritimos",
                column: "IdEnvio",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EnviosMaritimos_IdPuerto",
                table: "EnviosMaritimos",
                column: "IdPuerto");

            migrationBuilder.CreateIndex(
                name: "IX_EnviosTerrestres_IdBodega",
                table: "EnviosTerrestres",
                column: "IdBodega");

            migrationBuilder.CreateIndex(
                name: "IX_EnviosTerrestres_IdEnvio",
                table: "EnviosTerrestres",
                column: "IdEnvio",
                unique: true);
        }
